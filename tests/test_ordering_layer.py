...
class OrderingLayerTests(unittest.TestCase):
    ...
    def test_prepare_rows_is_independent_of_runtime_core_rebinding(self) -> None:
        ...
        with patch.object(
            ...
            # Reproduce main()'s runtime rebinding. Preparation must continue to
            # use its captured scoring helpers rather than recurse through core.
